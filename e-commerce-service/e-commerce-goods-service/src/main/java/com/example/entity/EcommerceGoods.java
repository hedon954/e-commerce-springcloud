...
import com.example.convertor.BrandCategoryConvertor;
import com.example.convertor.GoodsCategoryConvertor;
import com.example.convertor.GoodsStatusConvertor;
...
public class EcommerceGoods {
    ...
    @Convert(converter = GoodsCategoryConvertor.class)
    private GoodsCategory goodsCategory;

    /** 品牌分类 */
    @Column(name = "brand_category", nullable = false)
    @Convert(converter = BrandCategoryConvertor.class)
    ...
    @Convert(converter = GoodsStatusConvertor.class)
